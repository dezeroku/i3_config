...
#text files, codes
xdg-mime default subl.desktop application/sql
xdg-mime default subl.desktop text/plain
xdg-mime default subl.desktop text/x-python
xdg-mime default subl.desktop application/x-shellscript 
xdg-mime default subl.desktop text/css
xdg-mime default subl.desktop text/html
xdg-mime default subl.desktop application/xml
xdg-mime default subl.desktop text/x-c
#documents
